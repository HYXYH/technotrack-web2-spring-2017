...
class MyBlock extends React.Component {
    ...
    render() {
        ...
        let footer = <center><a href="#" onClick={this.props.changePageFunc.bind(this, 0)}> Лента </a><br/>
            <a href="#" onClick={this.props.changePageFunc.bind(this, 1)}> Cобытия </a> <br/>
        <a href="#" onClick={this.props.changePageFunc.bind(this, 2)}> Друзья (following) </a> <br/><br/>
